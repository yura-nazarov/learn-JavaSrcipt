...
const f2 = () => {
   let inn = document.querySelector('.i-2').value;
   s2 = new Set();
   s2.add(inn);
   console.log(s2);
}
...
const f3 = () => {
   let inn = document.querySelector('.i-3').value;
   s3.delete(inn);
   console.log(s3);
}
...
const f4 = () => {
   let inn = document.querySelector('.i-4').value;
   let outDiv = document.querySelector('.out-4');

   outDiv.innerHTML = s4.delete(inn) ? true : false;
}
...
const f5 = () => {
   let outDiv = document.querySelector('.out-5');
   outDiv.innerHTML = s5.size;
   console.log(s5);
}
...
const f7 = () => {
   let inn = document.querySelector('.i-7').value;
   let outDiv = document.querySelector('.out-7');
   let s7 = new Set(inn);
   console.log(s7);
   console.log(inn.length);
   outDiv.innerHTML = (s7.size == inn.length && inn.length > 6) ? 1 : 0;
}
