...
function createGET(block, param1, value1 = '', param2 = '', value2 = '', param3 = '', value3 = '') {
   ...
   xhttp.open("GET", `http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207&${param1}=${value1}&${param2}=${value2}&${param3}=${value3}`, true);
   xhttp.send();
...
function createPOST(block, param1, value1 = '', param2 = '', value2 = '', param3 = '', value3 = '') {
   let out = document.querySelector(block);
   let xhttp = new XMLHttpRequest();
   xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
   ...
   xhttp.send(`auth=7859d9d42a8834141d529577207&${param1}=${value1}&${param2}=${value2}&${param3}=${value3}`);
...
function t2() {
   createGET('.out-2', 'action', 2, 'name', 'Vitya');
...
function t3() {
   createGET('.out-3', 'action', 3, 'num1', 2, 'num2', 2);
...
function t4() {
   createGET('.out-4', 'action', 4, 'num1', 2, 'num2', 22);
...
function t6() {
   createGET('.out-6', 'action', 6, 'num1', 2, 'num2', 22);
}
...
function t8() {
   createGET('.out-8', 'action', 8, 'year', 2000);
}
...
function t9() {
   createGET('.out-9', 'action', 9, 'm', 1, 'd', 1, 'y', 1);
}
