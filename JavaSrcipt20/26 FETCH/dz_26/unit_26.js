...
function myFetchGET(block, param1, value1 = '', param2 = '', value2 = '', param3 = '', value3 = '') {
   fetch(`http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c&${param1}=${value1}&${param2}=${value2}&${param3}=${value3}`, {
...
function myFetchPOST(block, param1, value1 = '', param2 = '', value2 = '', param3 = '', value3 = '') {
   fetch('http://getpost.itgid.info/index2.php', {
      method: "POST", // *GET, POST, PUT, DELETE, etc.
      headers: {
         'Content-Type': 'application/x-www-form-urlencoded',
      },
      body: `auth=7859d9d42a8834141d529577207&${param1}=${value1}&${param2}=${value2}&${param3}=${value3}`,
   })
      .then(data => {
         console.log(data); // получаем Responce в виде большого ассоциативного массива
         return data.text(); // return позволяет передать указанные данные в следующий then
