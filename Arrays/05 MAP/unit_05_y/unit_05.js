...
const f1 = () => {
   a1_res = a1.map(elem => elem * 3);
   console.log('a1', a1);
   console.log('a1_res', a1_res);
}
...
const f2 = () => {
   a2_res = a2.map(elem => elem * 3);
   console.log('a2', a2);
   console.log('a2_res', a2_res);
}
...
const f3 = () => {
   a3_res = a3.map((item, index, array) => {
      if (index == 2) {
         array[3] = 100;
      }
      return item * 3
...
const f5 = () => {
   a5_res = a5.map((elem, index) => index);
   console.log(a5);
   console.log(a5_res);
}
...
const f6 = () => {
   a6_res = a6.map((elem, index) => index);
   console.log(a6);
   console.log(a6_res);
}
...
const f7 = () => {
   a7_res = a7.map((elem, index) => elem.length);
   console.log(a7);
   console.log(a7_res);
}
...
let a8 = [[1, 0, 0], [1, 0], [1, 0, 0, 0, 0]];
let a8_res;

const f8 = () => {
   let sum = 0;
   const a8fun = (item) => item.map(elem => {
...
const f10 = (arr, fucCallback) => {
   for (let i = 0; i < arr.length; i++) {
      a10_res[i] = fucCallback(arr[i]);
   }
   return a10_res;
}
